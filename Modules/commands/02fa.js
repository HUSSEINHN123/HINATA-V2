 module.exports.config = {
  ...
  hasPermssion: 0,
  credits: "HungCho",
  description: "صور من أنمي توكيو ريفنجرز",
  commandCategory: "صور",
  usages: "توكيو_ريفنجرز",
  cooldowns: 5,
  dependencies: {
    "request":"",
    "fs-extra":"",
...
var min = Math.floor(Math.random() * 2);
  ...
  var money = data.money
      if(money < 100) api.sendMessage("تحتاج إلى 100 دولار للرؤية صور من أنمي توكيو ريفنجرز ",event.threadID,event.messageID)
          else {
   Currencies.setData(event.senderID, options = {money: money - 10})
   var callback = () => api.sendMessage({body:`صور من أنمي توكيو ريفنجرز\nعدد الصور: ${link.length}\nلقد تم الخصم منك 100 دولار!`,attachment: fs.createReadStream(__dirname + "/cache/28.jpg")}, event.threadID, () => fs.unlinkSync(__dirname + "/cache/28.jpg"), event.messageID); 
