...
module.exports.run = async function ({ api, event, args }) {
  ...
  if (args.length === 0) {
    ...
    const response = `🤖 أوه مرحبا آمل أنك بخير يا, ${userName}! بادئتي الحالية هي ${currentPrefix}. هل ترغب في تغيير البادئة ؟ يمكنك إستخدام “ضبط البادئة[بادئة جديدة]” من أجل الحصول على بادئة جديدى.`;
