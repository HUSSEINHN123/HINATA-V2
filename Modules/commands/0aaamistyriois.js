...
module.exports.run = async ({ event, api, args, Users }) => {
  try {
    ...
    api.sendMessage({ attachment: fs.createReadStream(path_toilet, { 'highWaterMark': 128 * 1024 }), body: `فريد : إذا أنت كنت خلف هذا القناع طوال الوقت\n ${userName} : لكنت شردت بفعلتي لولا تدخلكم أيها الأطفال 😡 ` }, event.threadID, () => fs.unlinkSync(path_toilet), event.messageID);
  } catch (e) {
