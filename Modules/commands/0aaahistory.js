module.exports.config = {
  ...
  hasPermssion: 2,
  credits: "NTKhang",
  description: "عرض تاريخ استخدام البوت",
...
var history2 = hist.sort((a, b) => b.datenow - a.datenow);
  ...
  api.sendMessage("تاريخ الاستخدام الأخير للبوت حسب المجموعة هو\n\n" +msg+"\n"+dontuse, event.threadID, (err, info) => client.handleReaction.push({
...
module.exports.event = async function({ api, event, client, Threads, args, Users, global }) {
  ...
  var time = moment.tz("Africa/Casablanca").format("HH:mm:ss D/MM/YYYY");
