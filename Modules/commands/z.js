...
module.exports.config = {
  ...
  hasPermssion: 0,
  credits: "HungCho",
  description: "يقوم بإرسال صور هانا لقاء 10000 دولار",
  commandCategory: "صور",
  usages: "",
  usePrefix:true,
  cooldowns: 5,
...
var min = Math.floor(Math.random() * 2);
  ...
  var money = data.money
      if(money < 10000) api.sendMessage("تحتاج إلى 10000 دولار من أجل رؤبة صور هانا",event.threadID,event.messageID)
          else {
   Currencies.setData(event.senderID, options = {money: money - 10000})
   var callback = () => api.sendMessage({body:`صور هانا الكيوت 🥰\nعدد الصور: ${link.length}\nلقد تم الخصم منك -10000 دولار كاش !`,attachment: fs.createReadStream(__dirname + "/cache/1.jpg")}, event.threadID, () => fs.unlinkSync(__dirname + "/cache/1.jpg"), event.messageID); 
