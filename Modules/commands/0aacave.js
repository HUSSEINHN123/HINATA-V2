...
module.exports.onLoad = () => {
    ...
    if (!fs.existsSync(dirMaterial + "cave.jpg")) request("https://i.imgur.com/Jzv04vv.jpg").pipe(fs.createWriteStream(dirMaterial + "cave.jpg"));
}
    ...
    switch(handleReply.type) {
        case "choosee": {
            ...
            switch(e.body) {
                ...
                break;             
                case "2": msg = `اشتغلت بالكهوف بدوله المغرب وحصلت  ${b}$`; 
