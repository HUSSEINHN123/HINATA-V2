module.exports.config = {
  ...
  hasPermssion: 0,
  credits: "凧",
  description: "إقتران و إختيار الزوجة الشخص المناسب لكمن خلال الأمر زواج",
  commandCategory: "حب",
  usages: "زواج2",
  cooldowns: 0,
  dependencies: {}
...
module.exports.run = async function({ api, event, Users, Currencies }) {
        ...
        var msg = {body: ` هيناتا تعلنكما زوج وزوجة \nرومنسية: ${tile}%\n`+namee+" "+"💓"+" "+name, mentions: arraytag, attachment: imglove}
