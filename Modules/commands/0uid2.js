module.exports.config = {
 ...
 credits: "Nayan",
 usePrefix: true,
 description: "قم بالحصول على آيدي المستخدم.",
...
var name = res.data.result.name 
        var callback = () =>  api.sendMessage({body:`=== [ آيدي المستخدم ] ====\n━━━━━━━━━━━━━━━━━━\n[ ▶️]➜ الآيدي: ${event.senderID}\n[ ▶️]➜ رابط الدردشة: m.me/${event.senderID}\n[ ▶️]➜ رابط فيسبوك: https://www.facebook.com/profile.php?id=${event.senderID}\n━━━━━━━━━━━━━━━━━━`, attachment: fs.createReadStream(__dirname + "/cache/1.png")}, event.threadID,
        () => fs.unlinkSync(__dirname + "/cache/1.png"),event.messageID); 
...
var data = await api.getUserInfoV2(res_ID);
  ...
  if (args.join().indexOf('@') !== -1) 
      ...
      var callback = () => 
api.sendMessage({body:`=== [ آيدي فيسبوك ] ====\n━━━━━━━━━━━━━━━━━━\n[ ▶️]➜ الآيدي: ${uid}\n[ ▶️]➜ رابط الدردشة: m.me/${uid}\n[ ▶️]➜ رابط فيسبوك: https://www.facebook.com/profile.php?id=${uid}\n━━━━━━━━━━━━━━━━━━`, attachment: fs.createReadStream(__dirname + "/cache/1.png")}, event.threadID,
        () => fs.unlinkSync(__dirname + "/cache/1.png"),event.messageID); 
    return request(encodeURI(`https://graph.facebook.com/${uid}/picture?height=1500&width=1500&access_token=6628568379%7Cc1e620fa708a1d5696fb991c1bde5662`)).pipe(fs.createWriteStream(__dirname+'/cache/1.png')).on('close',
        () => callback()); 
