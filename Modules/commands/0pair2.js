...
var one = senderID, two = id;
    return makeImage({ one, two }).then(path => api.sendMessage({ body: `تهانينا يا ${namee} لقد تم إختيار لك زوجة وهي ${name}\nتققيم الترابط و الرومانسية بينكم هي: ${tle}`, mentions: arraytag, attachment: fs.createReadStream(path) }, threadID, () => fs.unlinkSync(path), messageID));
  }
