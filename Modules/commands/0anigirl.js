...
"https://i.postimg.cc/v8PP9Rd0/distorted.jpg",
    ...
    var callback = () => api.sendMessage({ body: `صور أنمي بروفايل من أجلك\nتاغ: أنمي طمس`, attachment: fs.createReadStream(__dirname + "/cache/5.jpg")}, event.threadID, () => fs.unlinkSync(__dirname + "/cache/5.jpg"), event.messageID);
