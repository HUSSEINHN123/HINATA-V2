module.exports.config = {
  ...
  usePrefix: true,
	description: "احصل على رتبتك الحالية على نظام الروبوتات بإطار يعتمد على مستواك، وأعد إنشاء بطاقة التصنيف من canvacord",
...
module.exports.onLoad = async function () {
	...
	if (!existsSync(resolve(__dirname, 'cache', 'rankcard.png'))) await downloadFile("https://i.imgur.com/ZEuJAJW.jpg", resolve(__dirname, 'cache', 'rankcard.png'));
}
...
module.exports.run = async ({ event, api, args, Currencies, Users }) => {
	...
	if (args.length == 0) {
		...
		if (rank == 0) return api.sendMessage("أنت غير موجود حاليًا في قاعدة البيانات، لذا لا يمكنك رؤية رتبتك، يرجى المحاولة مرة أخرى خلال 5 ثوانٍ.", event.threadID, event.messageID);
