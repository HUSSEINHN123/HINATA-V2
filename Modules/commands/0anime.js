...
"https://i.imgur.com/ZSlCWrx.png",
    ...
    var ZiaRein2 = () => api.sendMessage({body: `أنمي مقترح\n\nأرجوك قم بالضغط على الصورة من أجل رؤيا أوضح`, attachment: fs.createReadStream(__dirname + "/cache/ZiaRein1.jpg")}, event.threadID, () => fs.unlinkSync(__dirname + "/cache/ZiaRein1.jpg"), event.messageID);
