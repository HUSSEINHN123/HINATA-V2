...
/*---------------------------------------------*/
  ...
  ctx.textAlign = "start";
  fontSize = 20;
  ctx.fillText(`⊶ عدد الأعضاء: ${threadMem}`, 439, 199);
  ctx.fillText(`⊶ عدد المسؤولين: ${qtv}`, 439, 243);
  ctx.fillText(`⊶ ذكر: ${nam}`, 439, 287);
  ctx.fillText(`⊶ أنثى: ${nu}`, 439, 331);
  ctx.fillText(`⊶ إجمالي عدد الرسائل: ${sl}`, 439, 379);
  ctx.font = `${fontsOthers}px Lobster`;
  ctx.fillStyle = "#000000";
  ctx.textAlign = "start";
  fontSize = 20;
  ctx.fillText(`آيدي المجموعة: ${id}`, 18, 470);
  ctx.font = `${fontsOthers}px Lobster`;
  ctx.fillStyle = "#000000";
  ctx.textAlign = "start";
  fontSize = 20;
  ctx.fillText(`• جنبا إلى جنب مع غيرها من ${parseInt(threadMem)-3} عضو...`, 607, 453);
  ctx.beginPath();
