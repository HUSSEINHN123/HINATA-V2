...
var argss = `${money}`;
   ...
   const { loadImage, createCanvas } = require("canvas");
    ...
    let bg = (await axios.get(`https://i.imgur.com/J2V0Pzw.jpg`, {responseType: "arraybuffer" })).data;
    ...
    ctx.font = "120px SplineSans-Medium";
    ctx.fillStyle = "#000000";
    ctx.textAlign = "center";
    ctx.fillText('' + argss.replace(/\B(?=(\d{3})+(?!\d))/g, '') + '', 1945,470);
