...
"https://i.imgur.com/JQ3z84B.jpeg",
  ...
  var callback = () => api.sendMessage({body:`صور زيرو إثنان 😎 `,attachment: fs.createReadStream(__dirname + "/cache/5.jpg")}, event.threadID, () => fs.unlinkSync(__dirname + "/cache/5.jpg"));  
