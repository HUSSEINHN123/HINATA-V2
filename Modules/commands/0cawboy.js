...
if (author !== senderID) { return api.sendMessage('ليس دورك احترم دورك ولا تتدخل في آخرين يا غبي', threadID, messageID)};
...
let imag = (await axios.get(type_bo_win, {
        ...
        var msg = { body: `${name1} الرجل لقد اصتاد البقرة مبروك عليك !\nالمبلغ الربح   هو:  ${global.client.keobo[senderID].tienan}$`, attachment: imag }
        return api.sendMessage(msg, threadID, async () => {
                delete global.client.keobo[senderID];
            })
      } else {
