  ...
  hasPermssion: 0,
  credits: "HungCho",
  description: "مجموعة من صور الفنيات مع أزياء شخصيات الأنمي",
  commandCategory: "صور",
  usages: "يابان",
  cooldowns: 5,
  dependencies: {
...
"https://i.imgur.com/FhC4jXa.jpg",
     ...
     var callback = () => api.sendMessage({body:`كوسبلاي من اليابان 🏯\nعدد الصور 💹: ${link.length}`,attachment: fs.createReadStream(__dirname + "/cache/1.jpg")}, event.threadID, () => fs.unlinkSync(__dirname + "/cache/1.jpg"), event.messageID);  
